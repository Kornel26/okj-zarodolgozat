        ...
        <div class="card-body">
            <form action="{{route('admin.users.update', $user)}}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="vezeteknev" type="text" class="form-control" name="vezeteknev" value="{{ $user->vezeteknev }}" required autofocus>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="keresztnev" type="text" class="form-control" name="keresztnev" value="{{ $user->keresztnev }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="telefonszam" type="text" class="form-control" name="telefonszam" value="{{ $user->telefonszam }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="iranyitoszam" type="text" class="form-control" name="iranyitoszam" value="{{ $user->iranyitoszam }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="telepules" type="text" class="form-control" name="telepules" value="{{ $user->telepules }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="hazszam" type="text" class="form-control" name="hazszam" value="{{ $user->hazszam }}">
                    </div>
                </div>
